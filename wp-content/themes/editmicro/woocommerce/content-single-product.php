...
<div class="col-sm-9">
	<div class="product_details_main" >
		<div class="col-sm-7 product_big_img" id="product-<?php the_ID(); ?>">
			<?php
				/**
		...
		<div class="col-sm-5 product_info_text">
			<?php
				/**
...
<?php do_action( 'woocommerce_after_single_product' ); 
 echo do_shortcode("[wcps id='1370']"); ?>
?>
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/jquery.fancybox.js"></script>
	...
	<script type="text/javascript">
		...
		//	jQuery('a').addClass('fancybox');
			///jQuery('a').data('fancybox-group','gallery');
