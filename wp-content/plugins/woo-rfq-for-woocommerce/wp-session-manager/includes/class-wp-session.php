...
//echo "valid";
    ...
    $this->read_data();
        ...
        {
            $this->exp_variant = time() + (int)apply_filters('_rfqtk_wp_session_expiration_variant', 24 * 60 );
            $this->expires = time() + (int)apply_filters('_rfqtk_wp_session_expiration', 30 * 60 );
        }
