...
wpcfAccess.addSuggestedUser = function() {
		...
		$('.types-suggest-user').not( '.types-suggest-user-inited' ).addClass( 'types-suggest-user-inited' ).typesSuggest('wpcf_access_suggest_user', wpcfAccess.Suggest);
...
$(document).ready(function() {
	...
	jQuery( document ).on( 'js_event_types_access_permission_table_loaded', function( event, data ) {
		wpcfAccess.addSuggestedUser();
	});
});
