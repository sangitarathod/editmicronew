...
function wpgs_hooks() {
    ...
    add_action('wp_footer', 'wpgs_product_lightbox');
...
function wpgs_plugin_row_meta($links) {
        ...
        $row_meta = array(
            ...
            'docs' => '<a href="' . esc_url('http://codecanyon.net/item/twist-product-gallery-slidercarousel-plugin-for-woocommerce/14849108') . '" target="_blank" aria-label="' . esc_attr__('Pro Version', 'wpgs') . '" style="color:green;font-weight:600;">' . esc_html__('Pro Version', 'wpgs') . '</a>',
        );
